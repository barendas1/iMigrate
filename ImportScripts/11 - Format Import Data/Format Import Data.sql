    ...
    Begin
		Update MixInfo
			Set MixInfo.PlantCode = LTrim(RTrim(Replace(MixInfo.PlantCode, Char(160), ' '))),
				...
				MixInfo.BatchPanelCode = LTrim(RTrim(Replace(MixInfo.BatchPanelCode, Char(160), ' '))),
		        ...
		        MixInfo.MixClassDescription = LTrim(RTrim(Replace(MixInfo.MixClassDescription, Char(160), ' '))),
