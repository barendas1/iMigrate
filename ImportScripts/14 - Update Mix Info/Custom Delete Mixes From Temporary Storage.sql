Declare @MixesToKeep Table (AutoID Int)
/*
...
Select MixInfo.AutoID        
    ...
    Where ExistingMixes.ID Is Null And MixInfo.PlantCode In ('403', '404', '407', '439', '445', '446')
    Order By
            MixInfo.PlantCode,
            MixInfo.MixCode,
...
Delete MixInfo
From Data_Import_RJ.dbo.TestImport0000_MixInfo As MixInfo
Where MixInfo.AutoID Not In (Select AutoID From @MixesToKeep)
