...
Begin
	...
	Begin Try
        ...
        Update MaterialInfo
			Set	ConvertedCost = 
					Case
						When	IsNull(MaterialInfo.CostUnitName, '') Not In ('ml', 'li', '/m', 'to', 'CY', '/y', 'GL', 'GA', '$/gal', '$/GL', 'OZ', 'Dry Oz', '$/Dry Oz', 'TN', '$/Ton', '$/TN', 'LB', '$/lb', 'TON', 'Liter', 'Liters', 'Litres', '$/liter', 'KG', '$/Kg', 'LT', 'L', 'LL', 'TM', 'MT', '$/MTon') Or 
						...
						When IsNull(MaterialInfo.CostUnitName, '') In ('GL', '$/gal', 'GA', '$/GL')
		...
		Raiserror('', 0, 0) With Nowait
		Raiserror('One or more Materials may have been updated.', 0, 0) With Nowait
	End Try
	Begin catch
		If @@TRANCOUNT > 0
		Begin
		...
		Raiserror('', 0, 0) With Nowait
		Raiserror('The Materials could not be updated.  The Import was rolled back.', 0, 0) With Nowait
