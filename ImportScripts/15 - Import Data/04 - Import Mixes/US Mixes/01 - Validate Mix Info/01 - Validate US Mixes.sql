...
Select  MixRecipe.PlantCode As [Plant Name],
		...
		End As [Status Message],
		Case
			When Isnull(MixRecipe.QuantityUnitName, '') Not In ('ml/m3', 'ml/100kg', 'ML/100KG CM', 'OZ/CWT', 'CY', 'lb', 'ga', 'oz', 'fl oz', 'Fluid Oz', 'FO', 'L', 'LT', 'Liters', 'KG', 'Kilograms', 'ML', 'Milliliters', 'GAL', 'GL', 'LQ OZ', 'Ounces', 'oz/cwt CM', 'Pounds', 'Gallons', 'Per Cubic Yard', 'Cubic Yards', 'EA', 'Each', 'CC', 'GR', 'BG', 'BAG', 'BAGS')
			Then 'The Mix Recipe Quantity Units is not one of the following: lb, ga, oz, Fluid Oz, l, lt, kg, ml, GAL, LQ OZ, ounces, oz/cwt CM, pounds, gallons, Cubic Yards, Each, CC, GR, Bag, Bags'
			Else ''
		End As [Status Message]
...
Where	IsNull(MixRecipe.MaterialItemCode, '') = '' Or
		...
		Isnull(MixRecipe.QuantityUnitName, '') Not In ('ml/m3', 'ml/100kg', 'ML/100KG CM', 'OZ/CWT', 'lb', 'ga', 'oz', 'fl oz', 'Fluid Oz', 'FO', 'L', 'Liters', 'LT', 'KG', 'Kilograms', 'ML', 'Milliliters', 'GAL', 'GL', 'LQ OZ', 'Ounces', 'oz/cwt CM', 'Pounds', 'Gallons', 'CY', 'Cubic Yards', 'Per Cubic Yard', 'EA', 'Each', 'CC', 'GR', 'BG', 'BAG', 'BAGS')
